...
app = FastAPI(title='Backstract Generated APIs - coll-c2b7fcbbc7e74f91a3a4de5262d873dc', debug=False,
              docs_url='/sharp-hermann-5b2fba441ab511f0aae5260fe5ee2a8e71/docs',
              openapi_url='/sharp-hermann-5b2fba441ab511f0aae5260fe5ee2a8e71/openapi.json')
...
app.include_router(
    router,
    prefix='/sharp-hermann-5b2fba441ab511f0aae5260fe5ee2a8e71/api',
    tags=['APIs v1']
)
