...
app = FastAPI(title='Backstract Generated APIs - coll-c2b7fcbbc7e74f91a3a4de5262d873dc', debug=False,
              docs_url='/strange-yalow-5888b2bcea8d11efab560242ac1200053/docs',
              openapi_url='/strange-yalow-5888b2bcea8d11efab560242ac1200053/openapi.json')
...
app.include_router(
    router,
    prefix='/strange-yalow-5888b2bcea8d11efab560242ac1200053/api',
    tags=['APIs v1']
)
